    ...
    <div className="flex flex-col gap-6 w-full">
      <div className="relative w-full min-w-[200px]">
        <textarea
          ...
          className={`peer h-28 w-full border-b ${errorMessage ? "border-red-500" : "border-blue-gray-200"} bg-transparent pt-4 pb-1.5 font-sans text-lg font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 resize-none`} 
        />
        <label
          className={`
            ...
            leading-tight ${errorMessage ? "text-red-500" : "text-gray-500" } transition-all after:absolute ${errorMessage ? "after:bottom-2.5" : "after:-bottom-3.5"} after:block 
